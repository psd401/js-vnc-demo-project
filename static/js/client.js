(function () {
  ...
  Screen.prototype.drawRect = function (rect) {
    console.log(rect.image.length);
	
    //var imageArray = new Uint8Array(rect.image);
	
    var img = new Image(),
    	self = this;
	//image64 = decoder.decode(imageArray);
 ...
 //   console.log(image64);
  ...
  Screen.prototype.addMouseHandler = function (cb) {
    ...
    this._canvas.addEventListener('mouseup', function (e) {
      cb.call(null, e.layerX * sizeAspectRatio, e.layerY * sizeAspectRatio, 0);
      e.preventDefault();
    }, false);
 ...
 //     console.log(e);
      cb.call(null, e.layerX * sizeAspectRatio, e.layerY * sizeAspectRatio, mousestate);
      e.preventDefault();
    }, false);
  ...
  Client.prototype._addHandlers = function (callback) {
    var self = this;
    this._socket.on('init', function (serverconfig) {
